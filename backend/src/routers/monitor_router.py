...
async def get_asset_monitoring_overview_endpoint(
    ...
    try:
        return get_asset_monitoring_overview(sync=sync, limit=limit)
...
async def get_wallet_asset_monitoring_endpoint(
    ...
    try:
        return get_wallet_asset_monitoring(wallet_id, sync=sync, limit=limit)
...
async def get_address_asset_monitoring_endpoint(
    ...
    try:
        return get_address_asset_monitoring(address, sync=sync, limit=limit)
    except ValueError as ve:
